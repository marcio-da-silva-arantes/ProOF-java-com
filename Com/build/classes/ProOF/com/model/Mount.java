...
public class Mount {
    ...
    private void ERROR(Throwable ex, Class cls, String msg){
        System.err.printf(tab+"Error: "+msg+".\n");
        System.err.printf(tab+"\tIn         : %s\n", cls);
        System.err.printf(tab+"\tException  : %s\n", ex);
        ex.printStackTrace(System.err);
    }
    
    private <T extends Approach> T try_errors(final T service){
        if(service!=null){
            
            //============================ General UnsupportedOperationException =================================
            try{
                service.name();
            }catch(UnsupportedOperationException ex){
                ex.printStackTrace(System.err);//ERROR(ex, service.getClass(), "pre name() test detect a UnsupportedOperationException");
            }catch(Throwable ex){
            ...
            try{
                ...
                ex.printStackTrace(System.err);//ERROR(ex, service.getClass(), "pre services() test detect a UnsupportedOperationException");
            }catch(Throwable ex){
            ...
            try{
                ...
                ex.printStackTrace(System.err);//ERROR(ex, service.getClass(), "pre parameters() test detect a UnsupportedOperationException");
            }catch(Throwable ex){
            ...
            try{
                ...
                ex.printStackTrace(System.err);//ERROR(ex, service.getClass(), "pre load() test detect a UnsupportedOperationException");
            }catch(Throwable ex){
            ...
            try{
                ...
                ex.printStackTrace(System.err);//ERROR(ex, service.getClass(), "pre start() test detect a UnsupportedOperationException");
            }catch(Throwable ex){
            ...
            try{
                ...
                ex.printStackTrace(System.err);//ERROR(ex, service.getClass(), "pre results() test detect a UnsupportedOperationException");
            }catch(Throwable ex){
                
            }
            
            //============================ Specific UnsupportedOperationException =================================
            //Future: detect common erros in Problem for exeample
            
            //============================ General Throwable =================================
            try{
                service.name();
            }catch(Throwable ex){
                ex.printStackTrace(System.err);//ERROR(ex, service.getClass(), "approach name is not defined");
                //service = null;
            }
    ...
    private Factory try_errors(Factory factory){
        if(factory!=null){
            try{
                ...
                ex.printStackTrace(System.err);//ERROR(ex, factory.getClass(), "factory name is not defined");
            }
        }
        return factory;
    }
